...
var app = new Vue({
  ...
  data() {
    return {
      completed: true, // Whether csv file is selected
      ...
      chartType: 'Line', // Selected chart type
...
canvas.onclick = function(evt) {
		  ...
		  var activePoints = window.doc.getElementsAtEvent(evt);
		  if (activePoints[0]) {
			  ...
			  console.log(value)
			  document.getElementById('myVideo').currentTime = value;
			  document.getElementById('myVideo1').currentTime = value;
			  document.getElementById('myVideo2').currentTime = value;
		  }
	  };
